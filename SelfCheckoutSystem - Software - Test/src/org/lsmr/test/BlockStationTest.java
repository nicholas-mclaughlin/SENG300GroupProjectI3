...
public class BlockStationTest {
	    ...
	    public void setup() {
	        ...
	        // I think the inputs for this methods are wrong, not sure what is missing though
	    ...
	    public void scanControllerDisable() {
	    	...
	    	// disable and isDisabled are undefined
	    ...
	    public void scanControllerEnable() {
	    	...
	    	// disable, enable and isDisabled are undefined
	    	scanController.disable();
